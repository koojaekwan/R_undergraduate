...
survey데이터셋은 MASS library에 들어있는 데이터이다. 성별과 나이 그리고 왼손잡이인지 오른손잡이인지 여부 등 알 수 있다.
...
p-value가 0에 가까워 작은 유의수준에 대해서도 귀무가설을 기각할 수 있다. 즉, 귀무가설을 기각하고 "왼손잡이가 30% 오른손잡이 70%인 분포를 따르지 않는다" 라고 할 수 있다.
